...
namespace Portfolio_FinalProject.Models
{
    public class ProjectsController : Controller
    {
        ...
        {
            var projects = db.Projects.Include(p => p.ApplicationType);
        ...
        {
            ViewBag.TypeID = new SelectList(db.ApplicationTypes, "TypeID", "AppType");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectID,TypeID,Name,About,CodeLanguage,Picture,Link")] Project project)
        {
            if (ModelState.IsValid)
            {
